...
description: >
  ...
  Use when the user asks to find skills, browse skill catalogs, install a skill for Codex,
  or extend Codex's capabilities with reusable AI agent components.
license: MIT
---
...
4. Install by saving files to `.Codex/skills/{slug}/` and verify the SKILL.md exists
