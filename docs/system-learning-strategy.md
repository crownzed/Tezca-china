...
Tai lieu nay ket hop 2 nhanh nghien cuu:

- `docs/vocab-learning-strategy.md`: chien luoc tri nho, tu vung, SRS, va dac thu tieng Trung.
- `docs/behavioral-learning-strategy.md`: chien luoc tam ly hanh vi, habit, motivation, prompt, va nudge co dao duc.
