...
import { AlertCircle, CheckCircle2, Loader2, Lock, LockOpen, LogIn, LogOut, RefreshCw, RotateCcw, Save, ShieldCheck, Trash2, Users } from 'lucide-react';
import {
  adminDeleteUser,
  adminGetConfig,
  adminListUsers,
...
// Chip trạng thái tài khoản: xanh = đang hoạt động, đỏ = đã khoá. Không chỉ dựa
// vào màu — kèm icon + chữ để nhận biết được cả khi mù màu (color-not-only).
...
function UsersSection({ token, onAuthError }) {
  ...
  return (
    <section className="core-card admin-section">
      ...
      {/* KPI strip: tổng / đang hoạt động / đã khoá — trạng thái tổng quan */}
